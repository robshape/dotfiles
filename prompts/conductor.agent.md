...
2. **Delegate Research**: Use #runSubagent to invoke the plan-subagent for comprehensive context gathering. Instruct it to work autonomously without pausing.
...
1. Use #runSubagent to invoke the review-subagent with:
